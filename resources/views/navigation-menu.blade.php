        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="w-10 h-10 bg-neutral-500 text-white p-0.5 rounded-md block">
                            <path d="M9 22L6 15L3 22H9Z"></path>
                            <path
                            ...
                            <path d="M12.5 7.13288L17.7134 5.5293L15.8766 10.5293"></path>
                        </svg>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('admin.olts') }}" :active="request()->routeIs('admin.olts')">
                        {{ __('OLT networks') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('admin.antenas') }}" :active="request()->routeIs('admin.antenas')">
                        {{ __('Antenas') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('admin.recibos') }}" :active="request()->routeIs('admin.recibos')">
                        {{ __('Recibos') }}
                    </x-nav-link>
