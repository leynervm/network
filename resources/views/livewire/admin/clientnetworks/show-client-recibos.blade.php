<div>
    ...
    <div class="w-full flex justify-between items-start gap-3 mt-5">
        @if ($network->isActivo())
        ...
        <div class="w-full max-w-xs">
            ...
            <x-input class="w-full block mb-2" type="month" wire:model.lazy="searchmonth" />
        </div>
    </div>
    <x-table>
        <x-slot name="thead">
        ...
        <x-slot name="content">
            <form wire:submit.prevent="save" class="w-full grid grid-cols-1 gap-2">
                <div class="w-full">
                    ...
                    <select class="w-full block rounded-md border-gray-300 " wire:model.lazy="seriepago_id">
