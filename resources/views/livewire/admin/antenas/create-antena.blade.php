<div>
    <x-button wire:click="$toggle('open')">REGISTRAR ANTENA</x-button>

    <x-dialog-modal wire:model="open" maxWidth="xl">
        <x-slot name="title">
            <h1 class="font-semibold text-[10px]">REGISTRAR ANTENA</h1>
        ...
        <x-slot name="content">
            <form wire:submit.prevent="saveboxnav" class="w-full grid grid-cols-1 gap-2">
                <div class="w-full">
